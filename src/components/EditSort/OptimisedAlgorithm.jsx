...
function OptimisedAlgorithm() {
   ...
   const handleSubmit = async (e) => {
      try {
         ...
         const response = await axios.post("/admin/addoptlanguage", {
            sort: params.id,
            language,
            code,
         });
   ...
   const fetchData = async () => {
      try {
         setIsLoading(true);
         const response = await axios.get(`/admin/optimisedcode/${params.id}`);
   ...
   const deleteData = async (id) => {
      try {
         await axios.delete(`/admin/optimisedcode/${id}/delete`);
...
export default OptimisedAlgorithm;
